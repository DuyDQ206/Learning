...
ALTER TABLE DIEUKIEN ADD CONSTRAINT FK_MH_MONHOC FOREIGN KEY(MAMH) REFERENCES MONHOC(MAMH)
ALTER TABLE DIEUKIEN ADD CONSTRAINT FK_MHTRUOC_MONHOC FOREIGN KEY(MAMH_TRUOC) REFERENCES MONHOC(MAMH)
...
---- TURN ON CONSTRAINT ----
ALTER TABLE DIEUKIEN WITH CHECK CHECK CONSTRAINT ALL
ALTER TABLE GIANGDAY WITH CHECK CHECK CONSTRAINT ALL
ALTER TABLE GIAOVIEN WITH CHECK CHECK CONSTRAINT ALL
ALTER TABLE HOCVIEN WITH CHECK CHECK CONSTRAINT ALL
ALTER TABLE KETQUATHI WITH CHECK CHECK CONSTRAINT ALL
ALTER TABLE KHOA WITH CHECK CHECK CONSTRAINT ALL
ALTER TABLE LOP WITH CHECK CHECK CONSTRAINT ALL
